...
namespace Interactive360.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        private Button m_Button;                                            //Reference to the button game object that click will be sent to
        ...
        void Awake()
        {
            m_Button = m_Interactable.GetComponent<Button>();
            m_InteractiveItem = m_Interactable.GetComponent<VRInteractiveItem>();
